                                        ...
                                        <form class="form" action="{{route('admin.categories.store')}}" method="POST"enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1">اسم القسم_{{__('messages.'.$lang->abbr)}} </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <!-- <label for="projectinput1"> أختصار اللغة_{{__('messages.'.$lang->abbr)}}</label> -->
                                                            <input type="text" value="{{$lang->abbr}}" id="name"
                                                                   class="form-control"
                                                                   placeholder=""
                                                                   name="category[{{$index}}][abbr]" hidden>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput2"> الاتجاة_{{__('messages.'.$lang->abbr)}}</label>
                                                            <select name="category[{{$index}}][direction]" class="select2 form-control">
                                                                <optgroup label="من فضلك أختر اتجاه اللغة ">
                                                                    <option value="rtl"@if($lang->abbr=='ar') selected @endif>من اليمين الي اليسار</option>
                                                                    <option value="ltr"@if($lang->abbr=='en') selected @endif>من اليسار الي اليمين</option>
                                                                </optgroup>
                                                            </select>
                                                            @error("category.$index.direction")
                                                            <span class="text-danger">هذا الحقل مطلوب</span>
                                                            @enderror
                                                         </div>
                                                    </div>
